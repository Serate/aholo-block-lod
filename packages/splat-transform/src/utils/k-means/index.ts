...
function initializeCentroids1D(data: Float32Array, centroids: Float32Array) {
    const n = data.length;
...
function pickRandomIndices(n: number, m: number) {
...
function initializeCentroids(dataTable: Float32Array[], centroids: Float32Array[]) {
...
export async function kMeans(points: Float32Array[], k: number, iterations: number, device: GPUDevice) {
